...
package com.storehub.store.auth.endpoint;
...
import com.storehub.store.admin.api.entity.SysOauthClientDetails;
import com.storehub.store.admin.api.feign.RemoteClientDetailsService;
import com.storehub.store.admin.api.vo.TokenVo;
...
import com.storehub.store.common.security.util.OAuth2EndpointUtils;
import com.storehub.store.common.security.util.OAuth2ErrorCodesExpand;
import com.storehub.store.common.security.util.OAuthClientException;
...
public class StoreTokenEndpoint {

	private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new OAuth2AccessTokenResponseHttpMessageConverter();

	private final AuthenticationFailureHandler authenticationFailureHandler = new StoreAuthenticationFailureEventHandler();
