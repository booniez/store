...
package com.storehub.store.common.security.util;
...
public class SecurityUtils {
	 ...
	 * 获取用户
	 */
	public StoreUser getUser(Authentication authentication) {
		Object principal = authentication.getPrincipal();
		if (principal instanceof StoreUser) {
			return (StoreUser) principal;
		}
		return null;
	}
