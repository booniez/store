...
package com.storehub.store.common.feign.sentinel.ext;
 ...
 * @date 2020/6/9
 */
public final class StoreSentinelFeign {

	private StoreSentinelFeign() {

	}

	public static StoreSentinelFeign.Builder builder() {
		return new StoreSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public StoreSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new StoreSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new StoreSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new StoreSentinelInvocationHandler(target, dispatch);
				}
