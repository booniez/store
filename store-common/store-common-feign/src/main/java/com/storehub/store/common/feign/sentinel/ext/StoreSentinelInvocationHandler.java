 ...
 */
@Slf4j
public class StoreSentinelInvocationHandler implements InvocationHandler {
	...
	StoreSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			StoreSentinelInvocationHandler other = (StoreSentinelInvocationHandler) obj;
