...
import com.storehub.store.common.core.jackson.StoreJavaTimeModule;
...
public class SysLogListener implements InitializingBean {
	...
	private final StoreLogProperties logProperties;
	...
	public void afterPropertiesSet() {
		...
		objectMapper.registerModule(new StoreJavaTimeModule());
	}
