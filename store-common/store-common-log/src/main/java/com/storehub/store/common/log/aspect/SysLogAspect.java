...
public class SysLogAspect {
	...
	@SneakyThrows
	public Object around(ProceedingJoinPoint point, com.storehub.store.common.log.annotation.SysLog sysLog) {
		return SysLogUtils.proceedingJoinPoint(point, sysLog);
	}
